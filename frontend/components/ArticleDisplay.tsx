...
export default function ArticleDisplay({ article, onRegenerateRequest }: ArticleDisplayProps) {
  ...
  // Force re-render when showThai changes
  useEffect(() => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="card">
        <div className="article-content prose prose-lg max-w-none">
          <ReactMarkdown 
            ...
            {showThai && article.thaiContent ? article.thaiContent : article.content}
          </ReactMarkdown>
        </div>
      </div>
      ...
      {((showThai && article.thaiLayout ? article.thaiLayout : article.layout).imageSlots.length > 0) && (
        <div className="card">
          <div className="flex items-start space-x-4 mb-8">
            <div className="icon-wrapper w-16 h-16 flex-shrink-0">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex flex-col sm:flex-row sm:items-center gap-2 mb-2">
                <h3 className="text-2xl sm:text-3xl font-bold text-dark-navy-800 truncate">
                  Enhance with Images
                </h3>
                {showThai && article.thaiContent && (
                  <span className="text-lg sm:text-xl text-orange-600 font-medium whitespace-nowrap">
                    (Thai Version)
                  </span>
                )}
              </div>
      ...
      {article.analysis && (
        <div className="card">
          <div className="flex items-start space-x-4 mb-8">
            ...
            <div className="flex-1 min-w-0">
              <h3 className="text-2xl sm:text-3xl font-bold text-dark-navy-800 mb-2 truncate">
      ...
      {article.sourceUsageDetails && 
       ...
       article.sourceUsageDetails.some(detail => detail.sourceUrl && detail.sourceUrl.trim() !== '' && detail.sourceUrl !== 'N/A') && (
        <div className="card">
          <div className="flex items-start space-x-4 mb-8">
            <div className="icon-wrapper w-16 h-16 flex-shrink-0">
              <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
